...
ActiveRecord::Schema.define(version: 2021_06_03_132942) do
  ...
  create_table "comment_microposts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "comment"
    t.bigint "micropost_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["micropost_id"], name: "index_comment_microposts_on_micropost_id"
    t.index ["user_id"], name: "index_comment_microposts_on_user_id"
  end
  ...
  add_foreign_key "comment_microposts", "microposts"
  add_foreign_key "comment_microposts", "users"
